...
describe('iconerator', function () {
    ...
    */
    ...
    it('can generate all platform images and proper output directories', function (cb) {
        this.timeout(timeout);
        iconerator.generateIcons(testImg, testImg2, testImg3, outputPath, null, null, null, function (err) {
            assert.ifError(err);
    ...
    it('can generate only iOS images and proper output directories', function (cb) {
        this.timeout(timeout);
        iconerator.generateIcons(testImg, testImg2, testImg3, outputPath, "ios", null, null, function (err) {
            assert.ifError(err);
    ...
    it('can generate only Web images and proper output directories', function (cb) {
        this.timeout(timeout);
        iconerator.generateIcons(testImg, testImg2, testImg3, outputPath, "web", null, null, function (err) {
            assert.ifError(err);
    ...
    it('can generate only Android images and proper output directories', function (cb) {
        this.timeout(timeout);
        iconerator.generateIcons(testImg, testImg2, testImg3, outputPath, "android", null, null, function (err) {
            assert.ifError(err);
